...
statsmodels==0.14.1 "imageio==2.6.0" "imageio-ffmpeg==0.4.2" array2gif==1.0.4 \
    psutil==5.9.5 pynvml==11.5.3  gym==0.21.0 stable_baselines3==1.7.0 gymnasium==0.29.1  \
    tensorboard etils importlib_resources tensorboard-plugin-profile tensorflow plotly pysr sympy wandb hydra-core
