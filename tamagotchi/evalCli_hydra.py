...
def build_evalcli_defaults() -> dict:
    ...
    parser.add_argument('--rotate_by', type=int, default=0)
...
def main():
    ...
    parser.add_argument('--proceed', action='store_true', default=False,
                        help='Continue to eval loop after config comparison')
    ...
    # Step 4 (future): merge train_cfg into eval args and run eval_loop
    print("\n--proceed flag set — eval loop not yet implemented in evalCli_hydra.")
    sys.exit(0)
